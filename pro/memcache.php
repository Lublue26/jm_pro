...
define('ADMIN_PASSWORD','mnvnpasswordratkhonho');  	// Admin Password
define('DATE_FORMAT','Y/m/d H:i:s');
define('GRAPH_SIZE',200);
define('MAX_ITEM_DUMP',50);

$MEMCACHE_SERVERS[] = '127.0.0.1:11211'; // add more as an array
#$MEMCACHE_SERVERS[] = 'monngonvietnam.vn:11211'; // add more as an array
...
EOB;
        foreach($MEMCACHE_SERVERS as $server){
    		...
    		echo '<tr class=tr-0><td class=td-0>Memcached Server Version</td><td>'.$memcacheStatsSingle[$server]['STAT']['version'].'</td></tr>';
				echo '<tr class=tr-1><td class=td-0>Current Connections</td><td>',($memcacheStatsSingle[$server]['STAT']['curr_connections']),'</td></tr>';
				echo '<tr class=tr-0><td class=td-0>Total Connections</td><td>',($memcacheStatsSingle[$server]['STAT']['total_connections']),'</td></tr>';
