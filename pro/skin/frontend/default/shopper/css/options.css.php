...
@media only screen and (max-width: 490px) {
    .row {       width  : 100%;    }
.sorter{width: 80%;margin: auto;}
.col2-left-layout .products-grid, .col2-right-layout .products-grid{width: 100%;}
.col2-left-layout .col-main{width:100%;}
.two_columns_4 li.item {width: 203px;margin: 0 5px 30px;}


a.dissd {
 
  pointer-events:auto !important;    /* prevents click event */
  cursor: pointer !important;            /* use text highlight cursor*/
}
...
.two_columns_4 li.item {width: 41%;margin: 0 2.5% 30px;}
...
.sorter{width: 100%;margin: auto;}

.two_columns_4 li.item {width: 70%;margin: 0 13.5% 30px;}
