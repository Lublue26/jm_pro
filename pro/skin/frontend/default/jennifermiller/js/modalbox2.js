/*
Modalbox2 - The pop-up window thingie with AJAX, based on prototype and script.aculo.us.
...
if (!window.Modalbox2)
	var Modalbox2 = new Object();

Modalbox2.Methods = {
	overrideAlert: false, // Override standard browser alert message with Modalbox2
	focusableElements: new Array,
	options: {
		title: "Modalbox2 Window", // Title of the Modalbox2 window
		overlayClose: true, // Close modal box by clicking on overlay
		width: 500, // Default width in px
		height: 90, // Default height in px
		overlayOpacity: .75, // Default overlay opacity
		overlayDuration: .25, // Default overlay fade in/out duration in seconds
		slideDownDuration: .5, // Default Modalbox2 appear slide down effect in seconds
		slideUpDuration: .15, // Default Modalbox2 hiding slide up effect in seconds
	...
	_init: function(options) {
		...
		// Initial scrolling position of the window. To be used for remove scrolling effect during Modalbox2 appearing
	...
	hide: function(options) { // External hide method to use from external HTML and JS
		...
		} else throw("Modalbox2 isn't initialized");
	},
	
	alert: function(message){
		var html = '<div class="MB_alert"><p>' + message + '</p><input type="button" onclick="Modalbox2.hide()" value="OK" /></div>';
		Modalbox2.show(html, {title: 'Alert: ' + document.title, width: 300});
	},
	...
	_update: function() { // Updating MB in case of wizards
		...
		Modalbox2.resize((this.options.width - this.currentDims[0]), (this.options.height - this.currentDims[1]), {_afterResize: this._loadAfterResize.bind(this) });
	},
	...
	_putContent: function(){
		...
		if(this.options.height == this._options.height)
			Modalbox2.resize(0, this.MBcontent.getHeight() - Element.getHeight(this.MBwindow) + Element.getHeight(this.MBheader), {
	...
	_initObservers: function(){
		Event.observe(this.MBclose, "click", this.close);
		if(this.options.overlayClose) Event.observe(this.MBoverlay, "click", this.hide);
		Event.observe(document, "keypress", Modalbox2.kbdHandler );
	},
	
	_removeObservers: function(){
		Event.stopObserving(this.MBclose, "click", this.close);
		if(this.options.overlayClose) Event.stopObserving(this.MBoverlay, "click", this.hide);
		Event.stopObserving(document, "keypress", Modalbox2.kbdHandler );
	},
...
Object.extend(Modalbox2, Modalbox2.Methods);

if(Modalbox2.overrideAlert) window.alert = Modalbox2.alert;
